...
class selection_sort_tests(unittest.TestCase):
    ...
    def test_empty_list(self):
        lst = []
        sorted_lst = self.selection_sort(lst)
    ...
    def test_small_random(self):
        ...
        for i in range(0,10):
            ...
            small_list.append(n)
        sorted_lst = self.selection_sort(small_list)
    ...
    def test_medium_random(self):
        ...
        sorted_lst = self.selection_sort(medium_list)
    ...
    def test_large_random(self):
        ...
        for i in range(0,1000):
            n = random.randint(1,1000)
            large_list.append(n)
        sorted_lst = self.selection_sort(large_list)
